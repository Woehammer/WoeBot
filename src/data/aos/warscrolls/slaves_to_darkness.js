// ==================================================
// LOOKUP: AOS WARSCROLLS — SLAVES TO DARKNESS
...
const SLAVES_TO_DARKNESS = [
  ...
  },
  {
    ...
    faction: "Slaves to Darkness",
	aliases: [
      "scourge of ghyran abraxia, spear of the everchosen",
    ],
  },
  {
  ...
  {
    name: "Legion of the First Screamers of Tzeentch",
    faction: "Slaves to Darkness",
	aliases: [
...
export default SLAVES_TO_DARKNESS;