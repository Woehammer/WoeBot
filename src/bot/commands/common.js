// ==================================================
// COMMAND: /common
// PURPOSE: Top warscrolls by usage within a faction
...
export const data = new SlashCommandBuilder()
  .setName("common")
  .setDescription("Top warscrolls by usage within a faction (most commonly included)")
  .addStringOption((opt) =>
    opt
      .setName("faction")
...
export async function run(interaction, { system, engine }) {
  ...
  rows.sort((a, b) => {
    ...
    // tie-break: more games desc
    return b.incGames - a.incGames;
  });
  ...
  const header =
    ...
    `Ranked by **usage** (share of faction games that include the warscroll).`;
  ...
  const embed = new EmbedBuilder()
    .setTitle(`Most common warscrolls — ${factionName}`)
    .addFields(
